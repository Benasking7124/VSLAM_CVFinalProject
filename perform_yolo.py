...
def perform_yolo_on_images(model, left_image, right_image, required_detections):
    ...
    for obj in detections_left_image:
        ...
        for box in boxes:
            ...
            # Plot Bounding Box only if Detected Object is Required
            if model.names[int(box.cls)] in required_detections:
